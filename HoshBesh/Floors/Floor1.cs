...
namespace HoshBesh.Floors
{
    internal class Floor1 : BaseFloor
    {
        ...
        protected override StoryNode BuildStory()
        {
            ...
            StoryNode f1_riddle2Correct = new StoryNode("The baby dragon said 'You didn’t forget the crocodile. I’ll let you out of the cellar. Let’s see if you can escape the dungeon.'\n");
            ...
            StoryNode f1_rightPath = new StoryNode("You remembered that coconut is a flavour of HoshBesh biscuts and it grows on palm treee." +
                "\nYou walked on the right path. There was someone at the end of the way.\n");
            ...
            StoryNode f1_correctAnswer = new StoryNode("'Correct! The chicken is known for its cowardice. Here is the key. You can take it. Do not forget me!'"); ;
            ...
            f1_rightPath.Options.Add("continue", f1_cocoDragon);
            f1_leftPath.Options.Add("return", f1_retracePath);
            ...
            f1_riddle2Incorrect.Options.Add("return", f1_retracePath);

            f1_retracePath.Options.Add("down", f1_correctRetracePath);
            f1_retracePath.Options.Add("up", f1_cryingSound);

            f1_correctRetracePath.Options.Add("continue", f1_cocoDragon);

            f1_cryingSound.Options.Add("follow", f1_cocoDragon);
            f1_cryingSound.Options.Add("do not", f1_gameOver);
            ...
            f1_inspireDragon.Options.Add("take", f1_escapeFloor2);

            f1_chickenRiddle.Options.Add("chicken", f1_correctAnswer);
            f1_chickenRiddle.Options.Add("dragon", f1_wrongAnswer);

            f1_correctAnswer.Options.Add("take", f1_escapeFloor2);
            f1_wrongAnswer.Options.Add("take", f1_escapeFloor2);
